...
function Charts() {
  ...
  useEffect(() => {
    async function getData() {
      ...
      setBarChartData(buildBarSeries(GamesResponse.data, RecordsResponse.data.content));
      setPlatformData(getPlatformChartData(RecordsResponse.data.content));
      setGenderData(getGenderChartData(RecordsResponse.data.content));
    }
    getData()
  }, [])
